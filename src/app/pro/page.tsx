...
// import { sendOtp } from "@/actions/firebase";
// const OtpModal = dynamic(
//   () => import("@/components/Modals").then((mod) => mod.OtpModal),
//   { ssr: false }
// );
// const UploadModal = dynamic(
//   () => import("@/components/Modals").then((mod) => mod.UploadModal),
//   { ssr: false }
// );
...
//         });
//       } else if (type === "number") {
//         await sendOtp(phoneNumber); // Firebase send OTP
